...
func main() {
	...
	//tkn, _ := generateJWT(15)
	//fmt.Println(tkn)
	/*err := verifyJWT("eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2OTMyNDc2OTR9.F9GLIG2n8hklHKnvmtmAur1pzWMJoAu5JUroLX8vfUNGKeOZpGBRGiHMgFvjmUqIy2fK1XbZdFSZ7gAzp1ZuEg")
	if err != nil {
